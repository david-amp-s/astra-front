    ...
    <div className="w-[100vw] h-[100vh] bg-black text-white font-secundary text-center items-center justify-between flex flex-col">
      <div className="h-[15%] flex flex-col justify-center items-center text-center m-1.5">
        ...
        <p className="text-gray-300 text-sm md:text-base leading-relaxed">
          Descubre nuestras colecciones únicas, diseñadas para un momento especial para tu vida
        </p>
      </div>
      ...
      <section className="w-full h-[84%] flex items-center justify-around mb-3">
        ...
        <div className="relative w-[25%] h-full rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="relative flex flex-col items-center justify-between h-full p-6 text-center text-white">
            <div className="w-14 h-14 flex items-center justify-center rounded-full bg-black/60 border border-yellow-400 shadow-md">
              <Image src="/icons/daimond.png" alt="diamante logo" width={32} height={32} />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-gray-200 max-w-[240px] leading-relaxed">
                Piezas exclusivas que definen la elegancia suprema
              </p>
              <SpotlightCard
                className="mt-4 px-6 py-2 rounded-full bg-black/70 border border-yellow-400 text-yellow-300 font-semibold tracking-wide shadow-lg hover:scale-105 transition-transform"
                 spotlightColor="rgba(255, 215, 0, 0.25)"  
              >
                Ver colección
              </SpotlightCard>
            </div>
        ...
        <div className="relative w-[25%] h-full rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="relative flex flex-col items-center justify-between h-full p-6 text-center text-white">
            <div className="w-14 h-14 flex items-center justify-center rounded-full bg-black/60 border border-purple-400 shadow-md">
              <Image src="/icons/joyeria.png" alt="joyería logo" width={32} height={32} />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-gray-200 max-w-[240px] leading-relaxed">
                Diseños modernos y minimalistas que realzan tu estilo único
              </p>
              <SpotlightCard
                className="mt-4 px-6 py-2 rounded-full bg-black/70 border border-purple-400 text-purple-300 font-semibold tracking-wide shadow-lg hover:scale-105 transition-transform"
                spotlightColor="rgba(128, 0, 255, 0.25)"
              >
                Ver colección
              </SpotlightCard>
            </div>
        ...
        <div className="relative w-[25%] h-full rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="relative flex flex-col items-center justify-between h-full p-6 text-center text-white">
            <div className="w-14 h-14 flex items-center justify-center rounded-full bg-black/60 border border-pink-400 shadow-md">
              <Image src="/icons/collar-de-perlas.png" alt="collar logo" width={32} height={32} />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-gray-200 max-w-[240px] leading-relaxed">
                Joyería versátil para acompañarte en cada momento del día
              </p>
              <SpotlightCard
                className="mt-4 px-6 py-2 rounded-full bg-black/70 border border-pink-400 text-pink-300 font-semibold tracking-wide shadow-lg hover:scale-105 transition-transform"
                spotlightColor="rgba(255, 20, 147, 0.25)"
              >
                Ver colección
              </SpotlightCard>
            </div>
